...
//  MyPodDemo
//
//  Created by keshav vishwkarma on 01/08/2016.
//  Copyright (c) 2016 keshav vishwkarma. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    let blinkingLabel = MyLabel(frame: CGRectMake(10, 20, 200, 30))
